...
`r if (!("ic50" %in% opts$outcomes) | (opts$importance_grp == "" & opts$importance_ind == "")) "<!--"`
...
`r if (!("ic80" %in% opts$outcomes) | (opts$importance_grp == "" & opts$importance_ind == "")) "<!--"`
...
`r if (!("iip" %in% opts$outcomes) | (opts$importance_grp == "" & opts$importance_ind == "")) "<!--"`
## Variable importance
...
`r if (!("sens1" %in% opts$outcomes) | (opts$importance_grp == "" & opts$importance_ind == "")) "<!--"`
...
```{r get-pred-imp-sens1, eval = "sens1" %in% opts$outcomes & ("pred" %in% opts$importance_ind)}
fit_sens1 <- readRDS(paste0(slfits_dir, "fit_sens1.rds")
imp_sens1 <- extract_importance(fit_sens1, opts)
```

Table \@ref(tab:sens1-imp-table) shows the top `r n_imp_ft` features. `r ifelse("sens1" %in% opts$outcomes & ("pred" %in% opts$importance_ind), get_importance_text(opts = opts, imp_df = imp_sens1), "")`

```{r sens1-imp-table, eval = "sens1" %in% opts$outcomes & ("pred" %in% opts$importance_ind)}
...
`r if (!("sens2" %in% opts$outcomes) | (opts$importance_grp == "" & opts$importance_ind == "")) "<!--"`
## Variable importance
...
```{r get-pred-imp-sens2, eval = "sens2" %in% opts$outcomes & ("pred" %in% opts$importance_ind)}
fit_sens2 <- readRDS(paste0(slfits_dir, "fit_sens2.rds")
imp_sens2 <- extract_importance(fit_sens2, opts)
```

Table \@ref(tab:sens2-imp-table) shows the top `r n_imp_ft` features. `r ifelse("sens2" %in% opts$outcomes & ("pred" %in% opts$importance_ind), get_importance_text(opts = opts, imp_df = imp_sens2), "")`

```{r sens2-imp-table, eval = "sens2" %in% opts$outcomes & ("pred" %in% opts$importance_ind)}
