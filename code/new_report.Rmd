...
* out of the sequences with complete data, `r sum(dat$dichotomous.2)` were estimated to be resistant to the `r ifelse(length(opts$nab) > 1, "combination of antibodies", "antibody")`, while `r ncomplete - sum(dat$dichotomous.2)` were estimated to be sensitive (using multiple sensitivity)`r check_sl_vimp_bin(opts, run_sl_vimp_bools, "sens2")`
`r if(!("sens2" %in% opts$outcomes)) "-->"`
...
## make the table
kable(vimp_summary_marg, col.names = c("Variable group", colnames(vimp_summary_marg)[-1]), caption = get_biological_importance_table_description(opts, cont_nms, bin_nms, num_obs_full, num_obs_red, n_row_now, vimp_threshold, importance_type = "marginal"))
```
...
correct_description <- paste0(" Importance is measured via ", cont_nm_descr, ifelse(length(cont_nms) > 0 & length(bin_nms) > 0, " and ", ""), bin_nm_descr, ".")
## make the table
kable(vimp_summary_cond, col.names = c("Variable group", colnames(vimp_summary_cond)[-1]), caption = get_biological_importance_table_description(opts, cont_nms, bin_nms, num_obs_full, num_obs_red, n_row_now, vimp_threshold, importance_type = "conditional"))
```
...
kable(ic50_table, row.names = TRUE, digits = 3,
      caption = paste0("Summary statistics of IC-50 values for individual bnAbs (n = ", ncomplete, " observations with complete sequence data)."))
```

`r if ((length(opts$nab) == 1) | !("ic50" %in% opts$outcomes)) "-->"`

`r if (!("ic50" %in% opts$outcomes)) "<!--"`
A summary of the distribution of `r ifelse(length(opts$nab) == 1, "measured", "estimated")` IC-50 for the `r ifelse(length(opts$nab) == 1, "", "combination of")` selected broadly neutralizing `r ifelse(length(opts$nab) == 1, "antibody", "antibodies")` is shown in Figure \@ref(fig:histcombnic50).

```{r makecapic50, eval = "ic50" %in% opts$outcomes}
ic50_figcap <- if(length(opts$nab) == 1){
  paste0("Histogram of IC-50 for the selected broadly neutralizing antibody. Top row = original scale; bottom row = log10 scale (n = ", ncomplete, " observations with complete sequence data).")
}else{
...
```{r ic50groupvimp, eval = ("ic50" %in% opts$outcomes) & (("marg" %in% opts$importance_grp) | ("cond" %in% opts$importance_grp)), fig.cap = biological_importance_figure_caption(ncomplete, num_obs_full, num_obs_red, "ic50", grp = TRUE, marg = "marg" %in% opts$importance_grp, cond = "cond" %in% opts$importance_grp), fig.subcap = c("Marginal importance", "Conditional importance")}
...
kable(ic80_table, row.names = TRUE, digits = 3,
      caption = paste0("Summary statistics of IC-80 values for individual bnAbs (n = ", ncomplete, " observations with complete sequence data)."))
```

`r if ((length(opts$nab) == 1) | !("ic80" %in% opts$outcomes)) "-->"`

`r if (!("ic80" %in% opts$outcomes)) "<!--"`
A summary of the distribution of `r ifelse(length(opts$nab) == 1, "measured", "estimated")` IC-80 for the `r ifelse(length(opts$nab) == 1, "", "combination of")` selected broadly neutralizing `r ifelse(length(opts$nab) == 1, "antibody", "antibodies")` is shown in Figure \@ref(fig:histcombnic80).

```{r makecapic80, eval = "ic80" %in% opts$outcomes}
ic80_figcap <- if(length(opts$nab) == 1){
  paste0("Histogram of IC-80 for the selected broadly neutralizing antibody. Top row = original scale; bottom row = log10 scale (n = ", ncomplete, " observations with complete sequence data).")
}else{
...
```{r ic80groupvimp, eval = ("ic80" %in% opts$outcomes) & (("marg" %in% opts$importance_grp) | ("cond" %in% opts$importance_grp)), fig.cap = biological_importance_figure_caption(ncomplete, num_obs_full, num_obs_red, "ic80", grp = TRUE, marg = "marg" %in% opts$importance_grp, cond = "cond" %in% opts$importance_grp), fig.subcap = c("Marginal importance", "Conditional importance")}
if (("marg" %in% opts$importance_grp) & ("cond" %in% opts$importance_grp)) {
...
```{r ic80indivimp, eval = ("ic80" %in% opts$outcomes) & (("marg" %in% opts$importance_ind) | ("cond" %in% opts$importance_ind)), fig.cap = biological_importance_figure_caption(ncomplete, num_obs_full, num_obs_red, "ic80", grp = FALSE, marg = "marg" %in% opts$importance_ind, cond = "cond" %in% opts$importance_ind), fig.subcap = c("Marginal importance", "Conditional importance")}
if (("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) {
...
A summary of the distribution of IIP for the `r ifelse(length(opts$nab) == 1, "", "combination of")`selected broadly neutralizing `r ifelse(length(opts$nab) == 1, "antibody", "antibodies")` is shown in Figure \@ref(fig:histcombniip).

```{r makecapiip, eval = "iip" %in% opts$outcomes}
iip_figcap <- if(length(opts$nab) == 1){
  paste0("Histogram of IIP for the selected broadly neutralizing antibody (n = ", ncomplete, " observations with complete sequence data).")
}else{
...
```{r iipgroupvimp, eval = ("iip" %in% opts$outcomes) & (("marg" %in% opts$importance_grp) | ("cond" %in% opts$importance_grp)), fig.cap = biological_importance_figure_caption(ncomplete, num_obs_full, num_obs_red, "iip", grp = TRUE, marg = "marg" %in% opts$importance_grp, cond = "cond" %in% opts$importance_grp), fig.subcap = c("Marginal importance", "Conditional importance")}
if (("marg" %in% opts$importance_grp) & ("cond" %in% opts$importance_grp)) {
...
```{r iipindivimp, eval = ("iip" %in% opts$outcomes) & (("marg" %in% opts$importance_ind) | ("cond" %in% opts$importance_ind)), fig.cap = biological_importance_figure_caption(ncomplete, num_obs_full, num_obs_red, "iip", grp = FALSE, marg = "marg" %in% opts$importance_ind, cond = "cond" %in% opts$importance_ind), fig.subcap = c("Marginal importance", "Conditional importance")}
if (("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) {
...
```{r sens1superlearnerweighttable, eval = ("sens1" %in% opts$outcomes) & (length(opts$learners) > 1) & run_sl_vimp_bools$run_sl[grepl("sens1", opts$outcomes)][[1]]}
...
`r if (!("sens1" %in% opts$outcomes) | (!opts$cvperf) | !run_sl_vimp_bools$run_sl[grepl("sens1", opts$outcomes)][[1]]) "<!--"`

## Predictive performance

`r if (!("sens1" %in% opts$outcomes) | (!opts$cvperf) | !run_sl_vimp_bools$run_sl[grepl("sens1", opts$outcomes)][[1]]) "-->"`

`r if (!("sens1" %in% opts$outcomes) | !opts$cvperf | (length(opts$learners) == 1 & "sens1" %in% opts$outcomes) | !run_sl_vimp_bools$run_sl[grepl("sens1", opts$outcomes)][[1]]) "<!--"`
...
```{r plotdichot1, eval = ("sens1" %in% opts$outcomes) & (opts$cvperf) & run_sl_vimp_bools$run_sl[grepl("sens1", opts$outcomes)][[1]], fig.cap = paste0("Cross-validated AUC for predicting sensitivity based on estimated sensitivity (n = ", ncomplete, " observations with complete sequence data).")}
...
```{r roccap1, eval = ("sens1" %in% opts$outcomes) & (opts$cvperf) & run_sl_vimp_bools$run_sl[grepl("sens1", opts$outcomes)][[1]]}
...
```{r rocdichot1, fig.cap = roc_cap, eval = ("sens1" %in% opts$outcomes) & (opts$cvperf) & run_sl_vimp_bools$run_sl[grepl("sens1", opts$outcomes)][[1]]}
...
```{r predprob1, fig.cap = predprob_cap, eval = ("sens1" %in% opts$outcomes) & (opts$cvperf) & run_sl_vimp_bools$run_sl[grepl("sens1", opts$outcomes)][[1]]}
...
`r if (!("sens1" %in% opts$outcomes) | (all(opts$importance_grp == "") & all(opts$importance_ind == "")) | !run_sl_vimp_bools$run_sl[grepl("sens1", opts$outcomes)][[1]]) "<!--"`
...
`r if (!("sens1" %in% opts$outcomes) | ((opts$importance_grp == "") & !(("marg" %in% opts$importance_ind) | ("cond" %in% opts$importance_ind))) | !run_sl_vimp_bools$run_vimp[grepl("sens1", opts$outcomes)][[1]]) "<!--"`
...
`r if (!("sens1" %in% opts$outcomes) | (!("marg" %in% opts$importance_grp) & !("cond" %in% opts$importance_grp)) | !run_sl_vimp_bools$run_vimp[grepl("sens1", opts$outcomes)][[1]]) "<!--"`
...
```{r sens1groupvimp, eval = ("sens1" %in% opts$outcomes) & (("marg" %in% opts$importance_grp) | ("cond" %in% opts$importance_grp)) & run_sl_vimp_bools$run_vimp[grepl("sens1", opts$outcomes)][[1]], fig.cap = biological_importance_figure_caption(ncomplete, num_obs_full, num_obs_red, "sens1", grp = TRUE, marg = "marg" %in% opts$importance_grp, cond = "cond" %in% opts$importance_grp), fig.subcap = c("Marginal importance", "Conditional importance")}
if (("marg" %in% opts$importance_grp) & ("cond" %in% opts$importance_grp)) {
...
`r if (!("sens1" %in% opts$outcomes) | (!("marg" %in% opts$importance_ind) & !("cond" %in% opts$importance_ind)) | !run_sl_vimp_bools$run_vimp[grepl("sens1", opts$outcomes)][[1]]) "<!--"`

We show the biological variable importance of individual features in predicting estimated sensitivity in Figure \@ref(fig:sens1indivimp). Importance is defined using the difference in AUCs.
`r get_biological_importance_plot_description(opts, grp = FALSE)` `r (1-vimp_threshold)*100`\% confidence intervals and stars denoting p-values less than `r vimp_threshold` are displayed in blue.


```{r sens1indivimp, eval = ("sens1" %in% opts$outcomes) & (("marg" %in% opts$importance_ind) | ("cond" %in% opts$importance_ind)) & run_sl_vimp_bools$run_vimp[grepl("sens1", opts$outcomes)][[1]], fig.cap = biological_importance_figure_caption(ncomplete, num_obs_full, num_obs_red, "sens1", grp = FALSE, marg = "marg" %in% opts$importance_ind, cond = "cond" %in% opts$importance_ind), fig.subcap = c("Marginal importance", "Conditional importance")}
if (("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) {
...
`r if (!("sens1" %in% opts$outcomes) | !("pred" %in% opts$importance_ind) | !run_sl_vimp_bools$run_sl[grepl("sens1", opts$outcomes)][[1]]) "<!--"`

### Predictive importance

```{r get-pred-imp-sens1, eval = "sens1" %in% opts$outcomes & ("pred" %in% opts$importance_ind) & run_sl_vimp_bools$run_sl[grepl("sens1", opts$outcomes)][[1]]}
fit_sens1 <- readRDS(paste0(slfits_dir, "fit_dichotomous.1.rds"))
imp_sens1 <- extract_importance(fit_sens1, opts)
```

Table \@ref(tab:sens1-imp-table) shows the top `r n_imp_ft` features. `r ifelse("sens1" %in% opts$outcomes & ("pred" %in% opts$importance_ind) & run_sl_vimp_bools$run_sl[grepl("sens1", opts$outcomes)][[1]], get_importance_text(opts = opts, imp_df = imp_sens1), "")`

```{r sens1-imp-table, eval = "sens1" %in% opts$outcomes & ("pred" %in% opts$importance_ind) & run_sl_vimp_bools$run_sl[grepl("sens1", opts$outcomes)][[1]]}
...
`r if (!("sens2" %in% opts$outcomes) | (length(opts$learners) == 1) | !run_sl_vimp_bools$run_sl[grepl("sens2", opts$outcomes)][[1]]) "<!--"`
## Super learner results
...
```{r sens2superlearnerweighttable, eval = ("sens2" %in% opts$outcomes) & (length(opts$learners) > 1) & run_sl_vimp_bools$run_sl[grepl("sens2", opts$outcomes)][[1]]}
...
`r if (!("sens2" %in% opts$outcomes) | !opts$cvperf | !run_sl_vimp_bools$run_sl[grepl("sens2", opts$outcomes)][[1]]) "<!--"`

## Predictive performance

`r if (!("sens2" %in% opts$outcomes) | !opts$cvperf | !run_sl_vimp_bools$run_sl[grepl("sens2", opts$outcomes)][[1]]) "-->"`

`r if (!("sens2" %in% opts$outcomes) | !opts$cvperf | (length(opts$learners) == 1 & !opts$cvtune) | !run_sl_vimp_bools$run_sl[grepl("sens2", opts$outcomes)][[1]]) "<!--"`
...
```{r plotdichot2, eval = ("sens2" %in% opts$outcomes) & (opts$cvperf) & run_sl_vimp_bools$run_sl[grepl("sens2", opts$outcomes)][[1]], fig.cap = paste0("Cross-validated AUC for multiple sensitivity (n = ", ncomplete, " observations with complete sequence data).")}
...
```{r roccap2, eval = ("sens2" %in% opts$outcomes) & (opts$cvperf) & run_sl_vimp_bools$run_sl[grepl("sens2", opts$outcomes)][[1]]}
roc_cap <- if(length(opts$learners) > 1){
...
```{r rocdichot2, fig.cap = roc_cap, eval = ("sens2" %in% opts$outcomes) & (opts$cvperf) & run_sl_vimp_bools$run_sl[grepl("sens2", opts$outcomes)][[1]]}
...
```{r predprob2, fig.cap = predprob_cap, eval = ("sens2" %in% opts$outcomes) & (opts$cvperf) & run_sl_vimp_bools$run_sl[grepl("sens2", opts$outcomes)][[1]]}
...
`r if (!("sens2" %in% opts$outcomes) | (all(opts$importance_grp == "") & all(opts$importance_ind == "")) | !run_sl_vimp_bools$run_sl[grepl("sens2", opts$outcomes)][[1]]) "<!--"`
## Variable importance
...
`r if (!("sens2" %in% opts$outcomes) | ((opts$importance_grp == "") & !(("marg" %in% opts$importance_ind) | ("cond" %in% opts$importance_ind))) | !run_sl_vimp_bools$run_vimp[grepl("sens2", opts$outcomes)][[1]]) "<!--"`
...
`r if (!("sens2" %in% opts$outcomes) | (!("marg" %in% opts$importance_grp) & !("cond" %in% opts$importance_grp)) | !run_sl_vimp_bools$run_vimp[grepl("sens2", opts$outcomes)][[1]]) "<!--"`
...
```{r sens2groupvimp, eval = ("sens2" %in% opts$outcomes) & (("marg" %in% opts$importance_grp) | ("cond" %in% opts$importance_grp)) & run_sl_vimp_bools$run_vimp[grepl("sens2", opts$outcomes)][[1]], fig.cap = biological_importance_figure_caption(ncomplete, num_obs_full, num_obs_red, "sens2", grp = TRUE, marg = "marg" %in% opts$importance_grp, cond = "cond" %in% opts$importance_grp), fig.subcap = c("Marginal importance", "Conditional importance")}
if (("marg" %in% opts$importance_grp) & ("cond" %in% opts$importance_grp)) {
...
`r if (!("sens2" %in% opts$outcomes) | (!("marg" %in% opts$importance_ind) & !("cond" %in% opts$importance_ind)) | !run_sl_vimp_bools$run_vimp[grepl("sens2", opts$outcomes)][[1]]) "<!--"`
...
```{r sens2indivimp, eval = ("sens2" %in% opts$outcomes) & (("marg" %in% opts$importance_ind) | ("cond" %in% opts$importance_ind)) & run_sl_vimp_bools$run_vimp[grepl("sens2", opts$outcomes)][[1]], fig.cap = biological_importance_figure_caption(ncomplete, num_obs_full, num_obs_red, "sens2", grp = FALSE, marg = "marg" %in% opts$importance_ind, cond = "cond" %in% opts$importance_ind), fig.subcap = c("Marginal importance", "Conditional importance")}
if (("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) {
...
`r if (!("sens2" %in% opts$outcomes) | !("pred" %in% opts$importance_ind) | !run_sl_vimp_bools$run_sl[grepl("sens2", opts$outcomes)][[1]]) "<!--"`
### Predictive importance

```{r get-pred-imp-sens2, eval = "sens2" %in% opts$outcomes & ("pred" %in% opts$importance_ind) & run_sl_vimp_bools$run_sl[grepl("sens2", opts$outcomes)][[1]]}
fit_sens2 <- readRDS(paste0(slfits_dir, "fit_dichotomous.2.rds"))
imp_sens2 <- extract_importance(fit_sens2, opts)
```

Table \@ref(tab:sens2-imp-table) shows the top `r n_imp_ft` features. `r ifelse("sens2" %in% opts$outcomes & ("pred" %in% opts$importance_ind) & run_sl_vimp_bools$run_sl[grepl("sens2", opts$outcomes)][[1]], get_importance_text(opts = opts, imp_df = imp_sens2), "")`

```{r sens2-imp-table, eval = "sens2" %in% opts$outcomes & ("pred" %in% opts$importance_ind) & run_sl_vimp_bools$run_sl[grepl("sens2", opts$outcomes)][[1]]}
