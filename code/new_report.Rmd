...
date: "`r format(Sys.getenv('current_date'), '%d %B, %Y')`"
...
Table \@ref(tab:sens1-imp-table) shows the top `r n_imp_ft` features in terms of their predictive importance. `r ifelse("sens1" %in% opts$outcomes & ("pred" %in% opts$importance_ind) & run_sl_vimp_bools$run_sl[grepl("dichotomous.1", names(run_sl_vimp_bools$run_vimp))][[1]], get_importance_text(opts = opts, imp_df = imp_sens1), "")`
...
Table \@ref(tab:sens2-imp-table) shows the top `r n_imp_ft` features in terms of their predictive importance. `r ifelse("sens2" %in% opts$outcomes & ("pred" %in% opts$importance_ind) & run_sl_vimp_bools$run_sl[grepl("dichotomous.2", names(run_sl_vimp_bools$run_vimp))][[1]], get_importance_text(opts = opts, imp_df = imp_sens2), "")`
