...
<!-- Close of cv performance section -->
...
<!-- Close off marginal vimp section -->
...
<!-- close off conditional vimp section -->
...
<!-- close off multiple nabs section -->
...
<!-- close off the SL description section -->
...
<!-- close off cv performance section -->
...
`r if (!("marg" %in% opts$importance_grp) & !("cond" %in% opts$importance_grp)) "<!--"`
...
<!-- close off group importance section -->

`r if (!("marg" %in% opts$importance_grp) & !("cond" %in% opts$importance_grp)) "-->"`

<!-- If we did individual vimp, print it -->

`r if (!("marg" %in% opts$importance_ind) & !("cond" %in% opts$importance_ind)) "<!--"`
...
<!-- Close off the individual vimp section -->

`r if (!("marg" %in% opts$importance_ind) & !("cond" %in% opts$importance_ind)) "-->"`

<!-- close off the population variable importance section -->

`r if ((length(opts$importance_grp) == 0) & (length(opts$importance_ind) == 0)) "-->"`

### Predictive importance

<!-- close off the IC-50 section -->
...
<!-- close off multiple nab section -->
...
<!-- close off estimated sensitivity section -->
...
<!-- end multiple sensitivity section -->
