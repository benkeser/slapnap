...
We show the population-level variable importance of groups of features (defined in Table \@ref(tab:vimpGroupTab)) in predicting IC-50 in Figure \@ref(fig:ic50groupvimp). Importance is defined using the difference in R-squared values.
...
We show the population-level variable importance of individual features in predicting IC-50 in Figure \@ref(fig:ic50indivimp). Importance is defined using the difference in R-squared values.
...
```{r ic50indivimp, fig.cap = paste0("Individual variable importance for predicting IC-50. We used the ", ncomplete, " observations with complete sequence data in this analysis. To estimate the prediction functions based on all available features and geographic confounders only, we used ", num_obs_full, " observations. To estimate the prediction functions based on the reduced set of features (defined by removing the feature of interest) and the feature of interest plus geographic confounders, we used the remaining ", num_obs_red, "observations."), fig.subcap = c("Marginal importance", "Conditional importance"), fig.height = 10, fig.width = 20}
...
We show the population-level variable importance of groups of features (defined in Table \@ref(tab:vimpGroupTab)) in predicting IC-80 in Figure \@ref(fig:ic80groupvimp). Importance is defined using the difference in R-squared values.
`r if (("marg" %in% opts$importance_grp) & ("cond" %in% opts$importance_grp)) "The left-hand plot shows the marginal importance of the group relative to the null model with geographic confounders only. The right-hand plot shows the conditional importance of the group relative to all other groups."`
`r if (("marg" %in% opts$importance_grp) & !("cond" %in% opts$importance_grp)) "The plot shows the marginal importance of the group relative to the null model with geographic confounders only."`
`r if (!("marg" %in% opts$importance_grp) & ("cond" %in% opts$importance_grp)) "The plot shows the conditional importance of the group relative to all other groups."`

```{r ic80groupvimp, fig.cap = paste0("Group variable importance for predicting IC-80. We used the ", ncomplete, " observations with complete sequence data in this analysis. To estimate the prediction functions based on all available features and geographic confounders only, we used ", num_obs_full, " observations. To estimate the prediction functions based on the reduced set of features (defined by removing the feature group of interest) and the feature group of interest plus geographic confounders, we used the remaining ", num_obs_red, "observations."), fig.subcap = c("Marginal importance", "Conditional importance"), fig.height = 10, fig.width = 20}
if (("marg" %in% opts$importance_grp) & ("cond" %in% opts$importance_grp)) {
...
We show the population-level variable importance of individual features in predicting IC-80 in Figure \@ref(fig:ic80indivimp). Importance is defined using the difference in R-squared values.
`r if (("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) "The left-hand plot shows the marginal importance of the feature relative to the null model with geographic confounders only. The right-hand plot shows the conditional importance of the feature relative to all other features."`
`r if (("marg" %in% opts$importance_ind) & !("cond" %in% opts$importance_ind)) "The plot shows the marginal importance of the feature relative to the null model with geographic confounders only."`
`r if (!("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) "The plot shows the conditional importance of the feature relative to all other features."`
...
We show the population-level variable importance of groups of features (defined in Table \@ref(tab:vimpGroupTab)) in predicting IIP in Figure \@ref(fig:iipgroupvimp). Importance is defined using the difference in R-squared values.
`r if (("marg" %in% opts$importance_grp) & ("cond" %in% opts$importance_grp)) "The left-hand plot shows the marginal importance of the group relative to the null model with geographic confounders only. The right-hand plot shows the conditional importance of the group relative to all other groups."`
`r if (("marg" %in% opts$importance_grp) & !("cond" %in% opts$importance_grp)) "The plot shows the marginal importance of the group relative to the null model with geographic confounders only."`
`r if (!("marg" %in% opts$importance_grp) & ("cond" %in% opts$importance_grp)) "The plot shows the conditional importance of the group relative to all other groups."`

```{r iipgroupvimp, fig.cap = paste0("Group variable importance for predicting IIP. We used the ", ncomplete, " observations with complete sequence data in this analysis. To estimate the prediction functions based on all available features and geographic confounders only, we used ", num_obs_full, " observations. To estimate the prediction functions based on the reduced set of features (defined by removing the feature group of interest) and the feature group of interest plus geographic confounders, we used the remaining ", num_obs_red, "observations."), fig.subcap = c("Marginal importance", "Conditional importance"), fig.height = 10, fig.width = 20}
if (("marg" %in% opts$importance_grp) & ("cond" %in% opts$importance_grp)) {
...
We show the population-level variable importance of individual features in predicting IIP in Figure \@ref(fig:iipindivimp). Importance is defined using the difference in R-squared values.
`r if (("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) "The left-hand plot shows the marginal importance of the feature relative to the null model with geographic confounders only. The right-hand plot shows the conditional importance of the feature relative to all other features."`
`r if (("marg" %in% opts$importance_ind) & !("cond" %in% opts$importance_ind)) "The plot shows the marginal importance of the feature relative to the null model with geographic confounders only."`
`r if (!("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) "The plot shows the conditional importance of the feature relative to all other features."`

```{r iipindivimp, fig.cap = paste0("Individual variable importance for predicting IIP. We used the ", ncomplete, " observations with complete sequence data in this analysis. To estimate the prediction functions based on all available features and geographic confounders only, we used ", num_obs_full, " observations. To estimate the prediction functions based on the reduced set of features (defined by removing the feature of interest) and the feature of interest plus geographic confounders, we used the remaining ", num_obs_red, "observations."), fig.subcap = c("Marginal importance", "Conditional importance"), fig.height = 10, fig.width = 20}
if (("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) {
...
```{r plotdichot1, fig.cap = paste0("Cross-validated AUC for predicting sensitivity based on estimated sensitivity (n = ", ncomplete, "observations with complete sequence data)."), eval = "sens1" %in% opts$outcomes}
...
```{r sens1indivimp, fig.cap = paste0("Individual variable importance for predicting estimated sensitivity. We used the ", ncomplete, " observations with complete sequence data in this analysis. To estimate the prediction functions based on all available features and geographic confounders only, we used ", num_obs_full, " observations. To estimate the prediction functions based on the reduced set of features (defined by removing the feature of interest) and the feature of interest plus geographic confounders, we used the remaining ", num_obs_red, "observations."), fig.subcap = c("Marginal importance", "Conditional importance"), fig.height = 10, fig.width = 20}
if (("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) {
...
```{r sens2indivimp, fig.cap = paste0("Individual variable importance for predicting multiple sensitivity. We used the ", ncomplete, " observations with complete sequence data in this analysis. To estimate the prediction functions based on all available features and geographic confounders only, we used ", num_obs_full, " observations. To estimate the prediction functions based on the reduced set of features (defined by removing the feature of interest) and the feature of interest plus geographic confounders, we used the remaining ", num_obs_red, "observations."), fig.subcap = c("Marginal importance", "Conditional importance"), fig.height = 10, fig.width = 20}
if (("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) {
