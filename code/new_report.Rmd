...
if (in_container) {
  ...
  data_dir <- "/home/dat/"
    ...
    if (david_computer) {
        ...
        #              importance_grp = "marg", importance_ind = "marg;pred")
              opts <- list(nab = "VRC07-523-LS", outcomes = "ic50",
                     learners = "xgboost", cvtune = TRUE, cvperf = TRUE,
                     importance_grp = "", importance_ind = "pred")
...
`r get_biological_importance_plot_description(opts, grp = TRUE)`

```{r ic50groupvimp, eval = ("ic50" %in% opts$outcomes) & (("marg" %in% opts$importance_grp) | ("cond" %in% opts$importance_grp)), fig.cap = biological_importance_figure_caption(ncomplete, num_obs_full, num_obs_red, "ic50", grp = TRUE), fig.subcap = c("Marginal importance", "Conditional importance"), fig.height = 10, fig.width = 20}
...
`r get_biological_importance_plot_description(opts, grp = FALSE)`

```{r ic50indivimp, eval = ("ic50" %in% opts$outcomes) & (("marg" %in% opts$importance_ind) | ("cond" %in% opts$importance_ind)), fig.cap = biological_importance_figure_caption(ncomplete, num_obs_full, num_obs_red, "ic50", grp = FALSE), fig.subcap = c("Marginal importance", "Conditional importance"), fig.height = 10, fig.width = 20}
...
Table \@ref(tab:ic50-imp-table) shows the top `r n_imp_ft` features. `r ifelse("ic50" %in% opts$outcomes, get_importance_text(opts = opts, imp_df = imp_ic50), "")`

```{r ic50-imp-table, eval = "ic50" %in% opts$outcomes}
...
```{r ic80groupvimp, eval = ("ic80" %in% opts$outcomes) & (("marg" %in% opts$importance_grp) | ("cond" %in% opts$importance_grp)), fig.cap = biological_importance_figure_caption(ncomplete, num_obs_full, num_obs_red, "ic80", grp = TRUE), fig.subcap = c("Marginal importance", "Conditional importance"), fig.height = 10, fig.width = 20}
if (("marg" %in% opts$importance_grp) & ("cond" %in% opts$importance_grp)) {
...
```{r ic80indivimp, eval = ("ic80" %in% opts$outcomes) & (("marg" %in% opts$importance_ind) | ("cond" %in% opts$importance_ind)), fig.cap = biological_importance_figure_caption(ncomplete, num_obs_full, num_obs_red, "ic80", grp = FALSE), fig.subcap = c("Marginal importance", "Conditional importance"), fig.height = 10, fig.width = 20}
if (("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) {
...
```{r get-pred-imp-ic80, eval = "ic80" %in% opts$outcomes}
fit_ic80 <- readRDS(paste0(slfits_dir, "fit_log10.pc.ic80.rds"))
imp_ic80 <- extract_importance(fit_ic80, opts)
```

Table \@ref(tab:ic80-imp-table) shows the top `r n_imp_ft` features. `r ifelse("ic80" %in% opts$outcomes, get_importance_text(opts = opts, imp_df = imp_ic80), "")`

```{r ic80-imp-table, eval = "ic80" %in% opts$outcomes}
...
```{r iipgroupvimp, eval = ("iip" %in% opts$outcomes) & (("marg" %in% opts$importance_grp) | ("cond" %in% opts$importance_grp)), fig.cap = biological_importance_figure_caption(ncomplete, num_obs_full, num_obs_red, "iip", grp = TRUE), fig.subcap = c("Marginal importance", "Conditional importance"), fig.height = 10, fig.width = 20}
if (("marg" %in% opts$importance_grp) & ("cond" %in% opts$importance_grp)) {
...
```{r iipindivimp, eval = ("iip" %in% opts$outcomes) & (("marg" %in% opts$importance_ind) | ("cond" %in% opts$importance_ind)), fig.cap = biological_importance_figure_caption(ncomplete, num_obs_full, num_obs_red, "iip", grp = FALSE), fig.subcap = c("Marginal importance", "Conditional importance"), fig.height = 10, fig.width = 20}
if (("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) {
...
```{r get-pred-imp-iip, eval = "iip" %in% opts$outcomes}
fit_iip <- readRDS(paste0(slfits_dir, "fit_log10.pc.iip.rds"))
imp_iip <- extract_importance(fit_iip, opts)
```

Table \@ref(tab:iip-imp-table) shows the top `r n_imp_ft` features. `r ifelse("iip" %in% opts$outcomes, get_importance_text(opts = opts, imp_df = imp_iip), "")`

```{r iip-imp-table, eval = "iip" %in% opts$outcomes}
...
`r if (!("sens1" %in% opts$outcomes) | ((opts$importance_grp == "") & !(("marg" %in% opts$importance_ind) | ("cond" %in% opts$importance_ind)))) "<!--"`
...
```{r sens1groupvimp, eval = ("sens1" %in% opts$outcomes) & (("marg" %in% opts$importance_grp) | ("cond" %in% opts$importance_grp)), fig.cap = biological_importance_figure_caption(ncomplete, num_obs_full, num_obs_red, "sens1", grp = TRUE), fig.subcap = c("Marginal importance", "Conditional importance"), fig.height = 10, fig.width = 20}
if (("marg" %in% opts$importance_grp) & ("cond" %in% opts$importance_grp)) {
...
```{r sens1indivimp, eval = ("sens1" %in% opts$outcomes) & (("marg" %in% opts$importance_ind) | ("cond" %in% opts$importance_ind)), fig.cap = biological_importance_figure_caption(ncomplete, num_obs_full, num_obs_red, "sens1", grp = FALSE), fig.subcap = c("Marginal importance", "Conditional importance"), fig.height = 10, fig.width = 20}
if (("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) {
...
`r if (!("sens1" %in% opts$outcomes) | !("pred" %in% opts$importance_ind)) "<!--"`

### Predictive importance

```{r get-pred-imp-sens1, eval = "sens1" %in% opts$outcomes}
fit_sens1 <- readRDS(paste0(slfits_dir, "fit_sens1.rds")
imp_sens1 <- extract_importance(fit_sens1, opts)
```

Table \@ref(tab:sens1-imp-table) shows the top `r n_imp_ft` features. `r ifelse("sens1" %in% opts$outcomes, get_importance_text(opts = opts, imp_df = imp_sens1), "")`

```{r sens1-imp-table, eval = "sens1" %in% opts$outcomes}
...
`r if (!("sens2" %in% opts$outcomes) | ((opts$importance_grp == "") & !(("marg" %in% opts$importance_ind) | ("cond" %in% opts$importance_ind)))) "<!--"`
...
```{r sens2groupvimp, eval = ("sens2" %in% opts$outcomes) & (("marg" %in% opts$importance_grp) | ("cond" %in% opts$importance_grp)), fig.cap = biological_importance_figure_caption(ncomplete, num_obs_full, num_obs_red, "sens2", grp = TRUE), fig.subcap = c("Marginal importance", "Conditional importance"), fig.height = 10, fig.width = 20}
if (("marg" %in% opts$importance_grp) & ("cond" %in% opts$importance_grp)) {
...
```{r sens2indivimp, eval = ("sens2" %in% opts$outcomes) & (("marg" %in% opts$importance_ind) | ("cond" %in% opts$importance_ind)), fig.cap = biological_importance_figure_caption(ncomplete, num_obs_full, num_obs_red, "sens2", grp = FALSE), fig.subcap = c("Marginal importance", "Conditional importance"), fig.height = 10, fig.width = 20}
if (("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) {
...
`r if (!("sens2" %in% opts$outcomes) | !("pred" %in% opts$importance_ind)) "<!--"`
### Predictive importance

```{r get-pred-imp-sens2, eval = "sens2" %in% opts$outcomes}
fit_sens2 <- readRDS(paste0(slfits_dir, "fit_sens2.rds")
imp_sens2 <- extract_importance(fit_sens2, opts)
```

Table \@ref(tab:sens2-imp-table) shows the top `r n_imp_ft` features. `r ifelse("sens2" %in% opts$outcomes, get_importance_text(opts = opts, imp_df = imp_sens2), "")`

```{r sens2-imp-table, eval = "sens2" %in% opts$outcomes}
