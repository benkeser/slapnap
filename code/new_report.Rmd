...
We show the population-level variable importance of groups of features (defined in Table \@ref(tab:vimpGroupTab)) in predicting IC-50 in Figure \@ref(fig:ic50groupvimp). Importance is defined using the difference in $R^2$ values.
...
Placeholder estimated sensitivity text.
...
Placeholder multiple sensitivity text here.
