...
ic50_figcap <- if(length(opts$nab) == 1){
  paste0("Histogram of IC$_{50}$ for the selected broadly neutralizing antibody. Top row = original scale; bottom row = log$_{10}$ scale (n = ", ifelse(opts$same_subset, ncomplete_ic5080, ncomplete_ic50), " observations).")
}else{
  paste0("Histogram of estimated IC$_{50}$ for the combined neutralizing antibodies. Top row = original scale; bottom row = log$_{10}$ scale (n = ", ifelse(opts$same_subset, ncomplete_ic5080, ncomplete_ic50), " observations).")
}
```
...
```{r plotic50, eval = ("ic50" %in% opts$outcomes) & (opts$cvperf), fig.cap = paste0("Cross-validated $R^2$ for ", ifelse(length(opts$nab) == 1, "", "estimated"), " IC$_{50}$ (", ifelse(opts$same_subset, ncomplete_ic5080, ncomplete_ic50), " observations)")}
...
```{r plotic50predversusoutcomes, eval = ("ic50" %in% opts$outcomes) & (opts$cvperf), fig.cap = paste0("Cross-validated super learner predicted ", ifelse(length(opts$nab) == 1, "", "estimated"), " IC$_{50}$ plotted against actual IC$_{50}$ values (", ifelse(opts$same_subset, ncomplete_ic5080, ncomplete_ic50), " observations) . Colors correspond to cross-validation folds.")}
...
ic80_figcap <- if(length(opts$nab) == 1){
  paste0("Histogram of IC$_{80}$ for the selected broadly neutralizing antibody. Top row = original scale; bottom row = log$_{10}$ scale (n = ", ifelse(opts$same_subset, ncomplete_ic5080, ncomplete_ic80), " observations).")
}else{
  paste0("Histogram of estimated IC$_{80}$ for the combined neutralizing antibodies. Top row = original scale; bottom row = log$_{10}$ scale (n = ", ifelse(opts$same_subset, ncomplete_ic5080, ncomplete_ic80), " observations).")
}
```
...
```{r plotic80, eval = ("ic80" %in% opts$outcomes) & (opts$cvperf), fig.cap = paste0("Cross-validated $R^2$ for ", ifelse(length(opts$nab) == 1, "", "estimated "), "IC$_{80}$ (", ifelse(opts$same_subset, ncomplete_ic5080, ncomplete_ic80), " observations)")}
...
iip_figcap <- if(length(opts$nab) == 1){
  paste0("Histogram of IIP for the selected broadly neutralizing antibody (n = ", ncomplete_ic5080, " observations).")
}else{
  paste0("Histogram of estimated IIP for the combined neutralizing antibodies (n = ", ncomplete_ic5080, " observations).")
}
```
