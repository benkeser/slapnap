...
if (("marg" %in% opts$importance_grp) & ("cond" %in% opts$importance_grp)) {
  ...
  ic50_grp_vimp_grob_lst <- log10.pc.ic50_vimp_plots$grp_marginal
} else {
  ic50_grp_vimp_grob_lst <- log10.pc.ic50_vimp_plots$grp_conditional
}
grid.arrange(grobs = list(ic50_grp_vimp_grob_lst), ncol = length(opts$importance_grp), top = "Group Intrinsic Variable Importance")
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/ic50_intrinsic_import_grp_", postfix, ".png"), plot = grid.arrange(grobs = list(ic50_grp_vimp_grob_lst), ncol = length(opts$importance_grp), top = "Group Intrinsic Variable Importance"), width = 20, height = 20, units = "cm")
}
```
...
if (("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) {
  ...
  ic50_ind_vimp_grob_lst <- log10.pc.ic50_vimp_plots$ind_marginal
} else {
  ic50_ind_vimp_grob_lst <- log10.pc.ic50_vimp_plots$ind_conditional
}
...
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/ic50_intrinsic_import_ind_", postfix, ".png"), plot = grid.arrange(grobs = list(ic50_ind_vimp_grob_lst), ncol = ifelse("pred" %in% opts$importance_ind, length(opts$importance_ind) - 1, length(opts$importance_ind)), top = "Individual Intrinsic Variable Importance"), width = 20, height = 20, units = "cm")
}
```
...
if (("marg" %in% opts$importance_grp) & ("cond" %in% opts$importance_grp)) {
  ...
  ic80_grp_vimp_grob_lst <- log10.pc.ic80_vimp_plots$grp_marginal
} else {
  ic80_grp_vimp_grob_lst <- log10.pc.ic80_vimp_plots$grp_conditional
}
grid.arrange(grobs = list(ic80_grp_vimp_grob_lst), ncol = length(opts$importance_grp), top = "Group Intrinsic Variable Importance")
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/ic80_intrinsic_import_grp_", postfix, ".png"), plot = grid.arrange(grobs = list(ic80_grp_vimp_grob_lst), ncol = length(opts$importance_grp), top = "Group Intrinsic Variable Importance"), width = 20, height = 20, units = "cm")
}
```
...
if (("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) {
  ...
  ic80_ind_vimp_grob_lst <- log10.pc.ic80_vimp_plots$ind_marginal
} else {
  ic80_ind_vimp_grob_lst <- log10.pc.ic80_vimp_plots$ind_conditional
}
...
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/ic80_intrinsic_import_ind_", postfix, ".png"), plot = grid.arrange(grobs = list(ic80_ind_vimp_grob_lst), ncol = ifelse("pred" %in% opts$importance_ind, length(opts$importance_ind) - 1, length(opts$importance_ind)), top = "Individual Intrinsic Variable Importance"), width = 20, height = 20, units = "cm")
}
```
...
if (("marg" %in% opts$importance_grp) & ("cond" %in% opts$importance_grp)) {
  ...
  iip_grp_vimp_grob_lst <- iip_vimp_plots$grp_marginal
} else {
  iip_grp_vimp_grob_lst <- iip_vimp_plots$grp_conditional
}
grid.arrange(grobs = list(iip_grp_vimp_grob_lst), ncol = length(opts$importance_grp), top = "Group Intrinsic Variable Importance")
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/iip_intrinsic_import_grp_", postfix, ".png"), plot = grid.arrange(grobs = list(iip_grp_vimp_grob_lst), ncol = length(opts$importance_grp), top = "Group Intrinsic Variable Importance"), width = 20, height = 20, units = "cm")
}
```
...
if (("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) {
  ...
  iip_ind_vimp_grob_lst <- iip_vimp_plots$ind_marginal
} else {
  iip_ind_vimp_grob_lst <- iip_vimp_plots$ind_conditional
}
...
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/iip_intrinsic_import_ind_", postfix, ".png"), plot = grid.arrange(grobs = list(iip_ind_vimp_grob_lst), ncol = ifelse("pred" %in% opts$importance_ind, length(opts$importance_ind) - 1, length(opts$importance_ind)), top = "Individual Intrinsic Variable Importance"), width = 20, height = 20, units = "cm")
}
```
...
if (("marg" %in% opts$importance_grp) & ("cond" %in% opts$importance_grp)) {
  ...
  sens1_grp_vimp_grob_lst <- dichotomous.1_vimp_plots$grp_marginal
} else {
  sens1_grp_vimp_grob_lst <- dichotomous.1_vimp_plots$grp_conditional
}
grid.arrange(grobs = list(sens1_grp_vimp_grob_lst), ncol = length(opts$importance_grp), top = "Group Intrinsic Variable Importance")
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/", sens1_plot_nm, "_intrinsic_import_grp_", postfix, ".png"), plot = grid.arrange(grobs = list(sens1_grp_vimp_grob_lst), ncol = length(opts$importance_grp), top = "Group Intrinsic Variable Importance"), width = 20, height = 20, units = "cm")
}
```
...
if (("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) {
  ...
  sens1_ind_vimp_grob_lst <- dichotomous.1_vimp_plots$ind_marginal
} else {
  sens1_ind_vimp_grob_lst <- dichotomous.1_vimp_plots$ind_conditional
}
...
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/", sens1_plot_nm, "_intrinsic_import_ind_", postfix, ".png"), plot = grid.arrange(grobs = list(sens1_ind_vimp_grob_lst), ncol = ifelse("pred" %in% opts$importance_ind, length(opts$importance_ind) - 1, length(opts$importance_ind)), top = "Individual Intrinsic Variable Importance"), width = 20, height = 20, units = "cm")
}
```
...
if (("marg" %in% opts$importance_grp) & ("cond" %in% opts$importance_grp)) {
  ...
  sens2_grp_vimp_grob_lst <- dichotomous.2_vimp_plots$grp_marginal
} else {
  sens2_grp_vimp_grob_lst <- dichotomous.2_vimp_plots$grp_conditional
}
grid.arrange(grobs = list(sens2_grp_vimp_grob_lst), ncol = length(opts$importance_grp), top = "Group Intrinsic Variable Importance")
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/multsens_intrinsic_import_grp_", postfix, ".png"), plot = grid.arrange(grobs = list(sens2_grp_vimp_grob_lst), ncol = length(opts$importance_grp), top = "Group Intrinsic Variable Importance"), width = 20, height = 20, units = "cm")
}
```
...
if (("marg" %in% opts$importance_ind) & ("cond" %in% opts$importance_ind)) {
  ...
  sens2_ind_vimp_grob_lst <- dichotomous.2_vimp_plots$ind_marginal
} else {
  sens2_ind_vimp_grob_lst <- dichotomous.2_vimp_plots$ind_conditional
}
...
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/multsens_intrinsic_import_ind_", postfix, ".png"), plot = grid.arrange(grobs = list(sens2_ind_vimp_grob_lst), ncol = ifelse("pred" %in% opts$importance_ind, length(opts$importance_ind) - 1, length(opts$importance_ind)), top = "Individual Intrinsic Variable Importance"), width = 20, height = 20, units = "cm")
}
```
