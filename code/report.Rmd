...
The estimated cross-validated $R^2$ of the super learner for predicting continuous outcomes are shown in Table \@ref(rsquaredtable). The estimated cross-validated $R^2$ of the super learner for predicting binary sensitivity measures are shown in Table \@ref(auctable).
