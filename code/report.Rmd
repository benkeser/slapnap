...
```{r groupVimpCont, fig.cap = "Group variable importance for continuous outcomes", fig.height = 10, fig.width = 20}
...
if (!no_cv) {
    x_lab_cv <- expression(paste("Difference in CV-", R^2, sep = ""))
