...
grid.arrange(grobs = c(ic50_grp_vimp_grob_lst$conditional, ic50_grob_vimp_lst$marginal), ncol = 2)
```
...
grid.arrange(grobs = ic50_grp_vimp_grob_lst$individual, ncol = 1)
```
...
if (!reduce_outcomes) {
    ...
    grid.arrange(grobs = c(ic80_grp_vimp_grob_lst$conditional, ic80_grob_vimp_lst$marginal), ncol = 2)
} else {
    print("Only results for IC-50 are shown, since reduce_outcomes = TRUE.")
}
```
...
if (!reduce_outcomes) {
    ...
    grid.arrange(grobs = ic80_grp_vimp_grob_lst$individual, ncol = 1)
} else {
    print("Only results for IC-50 are shown, since reduce_outcomes = TRUE.")
}
```
...
if (!reduce_outcomes) {
    ...
    grid.arrange(grobs = c(iip_grp_vimp_grob_lst$conditional, iip_grob_vimp_lst$marginal), ncol = 2)
} else {
    print("Only results for IC-50 are shown, since reduce_outcomes = TRUE.")
}
```
...
if (!reduce_outcomes) {
    ...
    grid.arrange(grobs = iip_grp_vimp_grob_lst$individual, ncol = 1)
} else {
    print("Only results for IC-50 are shown, since reduce_outcomes = TRUE.")
}
```
...
if (!reduce_outcomes) {
    ...
    grid.arrange(grobs = c(dichotomous.1_grp_vimp_grob_lst$conditional, dichotomous.1_grob_vimp_lst$marginal), ncol = 2)
} else {
    print("Only results for IC-50 are shown, since reduce_outcomes = TRUE.")
}
```
...
if (!reduce_outcomes) {
    ...
    grid.arrange(grobs = dichotomous.1_grp_vimp_grob_lst$individual, ncol = 1)
} else {
    print("Only results for IC-50 are shown, since reduce_outcomes = TRUE.")
}
```
...
if (!reduce_outcomes) {
    ...
    grid.arrange(grobs = c(dichotomous.2_grp_vimp_grob_lst$conditional, dichotomous.2_grob_vimp_lst$marginal), ncol = 2)
} else {
    print("Only results for IC-50 are shown, since reduce_outcomes = TRUE.")
}
```
...
if (!reduce_outcomes) {
    ...
    grid.arrange(grobs = dichotomous.2_grp_vimp_grob_lst$individual, ncol = 1)
} else {
    print("Only results for IC-50 are shown, since reduce_outcomes = TRUE.")
}
```
