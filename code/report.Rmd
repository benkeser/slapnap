...
kable(imp_overall, caption = paste0("Variable importance of individual features in the Super Learner, defined by being label as 'important' for prediction of at least two of the outcomes considered; these outcomes are listed in the table (n = ", n_row_now, " observations with complete sequence data)."))
```
