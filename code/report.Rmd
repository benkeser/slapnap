...
grid.arrange(grobs = c(ic50_grp_vimp_grob_lst$conditional, ic50_grp_vimp_grob_lst$marginal), ncol = 2)
```
...
if (!reduce_outcomes) {
    ...
    grid.arrange(grobs = c(ic80_grp_vimp_grob_lst$conditional, ic80_grp_vimp_grob_lst$marginal), ncol = 2)
} else {
    print("Only results for IC-50 are shown, since reduce_outcomes = TRUE.")
}
```
...
if (!reduce_outcomes) {
    ...
    grid.arrange(grobs = c(iip_grp_vimp_grob_lst$conditional, iip_grp_vimp_grob_lst$marginal), ncol = 2)
} else {
    print("Only results for IC-50 are shown, since reduce_outcomes = TRUE.")
}
```
...
if (!reduce_outcomes) {
    ...
    grid.arrange(grobs = c(dichotomous.1_grp_vimp_grob_lst$conditional, dichotomous.1_grp_vimp_grob_lst$marginal), ncol = 2)
} else {
    print("Only results for IC-50 are shown, since reduce_outcomes = TRUE.")
}
```
...
if (!reduce_outcomes) {
    ...
    grid.arrange(grobs = c(dichotomous.2_grp_vimp_grob_lst$conditional, dichotomous.2_grp_vimp_grob_lst$marginal), ncol = 2)
} else {
    print("Only results for IC-50 are shown, since reduce_outcomes = TRUE.")
}
```
