...
```{r variables}
metadata_tab <- create_metadata()
```

# Variable group definitions

Table \@ref(tab:vimpGroupTab) provides the individual HXB2 coordinates and variable names of the variables that make up each of the variable groups considered for biological importance`r ifelse(!(opts$importance_grp == ""), "" " (however, in the SLAPNAP call that generated this dataset, biological importance was not requested)")`.
