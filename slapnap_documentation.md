...
The CATNAP data are updated periodically. The data are downloaded into the `slapnap` container at every build. The most recent build occurred on November 04, 2020.
