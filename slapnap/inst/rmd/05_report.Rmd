...
library(slapnap)
preamble_file = system.file("scripts", "05_report_preamble.R", package = "slapnap")
...
```{r, histic50, eval = ("ic50" %in% opts$outcomes) & !one_nab, fig.cap = paste0("Distribution of IC$_{50}$ values (n = ", ifelse(opts$same_subset, ncomplete_ic5080, ncomplete_ic50), ") for each bnAb.")}
ic50_descr <- get_individual_nab_summaries("ic50", opts, dat_ic50)
ic50_hist <- do.call(arrangeGrob, ic50_descr$hist)
grid.draw(ic50_hist)
# if saving figures was requested, save
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/ic50_hist_", postfix, ".png"), plot = ic50_hist, width = 20, height = 20, units = "cm")
}
```
...
ic50_combn_hist <- do.call(arrangeGrob, combn_hist)
grid.draw(ic50_combn_hist)
# if saving figures was requested, save
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/ic50_combn_hist_", postfix, ".png"), plot = ic50_combn_hist, width = 20, height = 20, units = "cm")
}
```
...
ic50_plot <- cowplot::plot_grid(plotlist = ic50_grp_vimp_grob_lst, ncol = length(opts$importance_grp))
ic50_plot
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/", "ic50", "_intrinsic_import_grp_", postfix, ".png"), plot = ic50_plot, width = 40, height = 20, units = "cm")
}
```
...
ic50_indiv_vim_plot <- cowplot::plot_grid(plotlist = ic50_ind_vimp_grob_lst, ncol = ncol_ind_vim)
ic50_indiv_vim_plot
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/", "ic50", "_intrinsic_import_ind_", postfix, ".png"), plot = ic50_indiv_vim_plot, width = 40, height = 20, units = "cm")
}
```
...
```{r, histic80, eval = ("ic80" %in% opts$outcomes) & (!one_nab), fig.cap = paste0("Distribution of IC$_{80}$ values (n = ", ifelse(opts$same_subset, ncomplete_ic5080, ncomplete_ic80), ") for each bnAb.")}
ic80_descr <- get_individual_nab_summaries("ic80", opts, dat_ic80)
ic80_hist <- do.call(arrangeGrob, ic80_descr$hist)
grid.draw(ic80_hist)
# if saving figures was requested, save
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/ic80_hist_", postfix, ".png"), plot = ic80_hist, width = 20, height = 20, units = "cm")
}
```
...
ic80_combn_hist <- do.call(arrangeGrob, combn_hist)
grid.draw(ic80_combn_hist)
# if saving figures was requested, save
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/ic80_combn_hist_", postfix, ".png"), plot = ic80_combn_hist, width = 20, height = 20, units = "cm")
}
```
...
ic80_plot <- cowplot::plot_grid(plotlist = ic80_grp_vimp_grob_lst, ncol = length(opts$importance_grp))
ic80_plot
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/", "ic80", "_intrinsic_import_grp_", postfix, ".png"), plot = ic80_plot, width = 40, height = 20, units = "cm")
}
```
...
ic80_indiv_vim_plot <- cowplot::plot_grid(plotlist = ic80_ind_vimp_grob_lst, ncol = ncol_ind_vim)
ic80_indiv_vim_plot
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/", "ic80", "_intrinsic_import_ind_", postfix, ".png"), plot = ic80_indiv_vim_plot, width = 40, height = 20, units = "cm")
}
```
...
iip_combn_hist <- do.call(arrangeGrob, combn_hist)
grid.draw(iip_combn_hist)
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/iip_combn_hist_", postfix, ".png"), plot = iip_combn_hist, width = 20, height = 20, units = "cm")
}
```
...
iip_plot <- cowplot::plot_grid(plotlist = iip_grp_vimp_grob_lst, ncol = length(opts$importance_grp))
iip_plot
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/", "iip", "_intrinsic_import_grp_", postfix, ".png"), plot = iip_plot, width = 40, height = 20, units = "cm")
}
```
...
iip_indiv_vim_plot <- cowplot::plot_grid(plotlist = iip_ind_vimp_grob_lst, ncol = ncol_ind_vim)
iip_indiv_vim_plot
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/", "iip", "_intrinsic_import_ind_", postfix, ".png"), plot = iip_indiv_vim_plot, width = 40, height = 20, units = "cm")
}
```
...
sens1_plot <- cowplot::plot_grid(plotlist = sens1_grp_vimp_grob_lst, ncol = length(opts$importance_grp))
sens1_plot
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/", sens1_plot_nm, "_intrinsic_import_grp_", postfix, ".png"), plot = sens1_plot, width = 40, height = 20, units = "cm")
}
```
...
sens1_indiv_vim_plot <- cowplot::plot_grid(plotlist = sens1_ind_vimp_grob_lst, ncol = ncol_ind_vim)
sens1_indiv_vim_plot
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/", sens1_plot_nm, "_intrinsic_import_ind_", postfix, ".png"), plot = sens1_indiv_vim_plot, width = 40, height = 20, units = "cm")
}
```
...
sens2_plot <- cowplot::plot_grid(plotlist = sens2_grp_vimp_grob_lst, ncol = length(opts$importance_grp))
sens2_plot
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/", "multsens", "_intrinsic_import_grp_", postfix, ".png"), plot = sens2_plot, width = 40, height = 20, units = "cm")
}
```
...
sens2_indiv_vim_plot <- cowplot::plot_grid(plotlist = sens2_ind_vimp_grob_lst, ncol = ncol_ind_vim)
sens2_indiv_vim_plot
if ("figures" %in% opts$return) {
    ggsave(filename = paste0("/home/output/", "multsens", "_intrinsic_import_ind_", postfix, ".png"), plot = sens2_indiv_vim_plot, width = 40, height = 20, units = "cm")
}
```
