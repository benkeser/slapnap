...
log10.pc.ic50_any_signif <- log10.pc.ic80_any_signif <- iip_any_signif <- dichotomous.1_any_signif <- dichotomous.2_any_signif <-  list(grp_conditional = FALSE, grp_marginal = FALSE, ind_conditional = FALSE, ind_marginal = FALSE)
...
threshold = vimp_threshold, outcome_names = all_outcome_names, cv = use_cv, opts = opts)
any_signif_all <- any(
