...
ensemble is constructed. In the following command, we construct an
ensemble based on a random forest and elastic net. Note that the
...
additional time incurred by evaluating its cross-validated performance.
