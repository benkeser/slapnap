...
\item
  ...
  compiled report should be made viewable on \texttt{localhost}. If
  \texttt{"TRUE"} then \texttt{-p} option should be used in the
  \texttt{docker\ run} command to identify the port. See examples for
  details.
\end{itemize}
