...
nAb\texttt{\{r,\ echo\ =\ FALSE\}\ knitr::opts\_chunk\$set(\ \ \ comment\ =\ "\#\textgreater{}",\ \ \ out.width\ =\ "70\%",\ \ \ fig.align\ =\ \textquotesingle{}center\textquotesingle{},\ \ \ fig.width\ =\ 6,\ \#\ used\ to\ have:\ fig.width\ =\ 12,\ \ \ fig.asp\ =\ 0.618,\ \#\ used\ to\ have:\ fig.height\ =\ 4,\ \ \ fig.show\ =\ "hold",\ \ \ fig.path\ =\ \textquotesingle{}img/\textquotesingle{},\ \ \ size\ =\ "tiny",\ \ \ message\ =\ FALSE,\ \ \ warning\ =\ FALSE,\ \ \ warnings\ =\ FALSE\ )}
...
request marginal group and individual biological importance and
