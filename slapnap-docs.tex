...
\hypersetup{
            ...
            pdfauthor={David Benkeser, Brian D. Williamson, Craig A. Magaret, Sohail Nizam, Courtney Simmons, Peter B. Gilbert},
            pdfborder={0 0 0},
            breaklinks=true}
...
boosted trees \citep{friedman2001, chen2016} as implemented in either
\texttt{xgboost} \citep{xgboostpkg} or \texttt{H2O.ai} \citep{h2opkg}.
